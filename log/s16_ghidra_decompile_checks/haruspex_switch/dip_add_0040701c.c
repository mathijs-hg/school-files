...
void dip_add(undefined4 param_1,int param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  local_18[0] = 0;
[32m  if ((*(int *)(param_2 + 0x10) == 0) || (sVar1 = strlen(*(char **)(param_2 + 0x10)), sVar1 != 8)) {[0m
    puts("portmap format error, should be of length 7");
  }
  else {
    local_1c = 0;
    for (local_20 = 0; local_20 < 7; local_20 = local_20 + 1) {
      if ((*(char *)(*(int *)(param_2 + 0x10) + local_20) != '0') &&
         (*(char *)(*(int *)(param_2 + 0x10) + local_20) != '1')) {
        puts("portmap format error, should be of combination of 0 or 1");
        return;
      }
      local_1c = local_1c +
                 (*(char *)(*(int *)(param_2 + 0x10) + local_20) + -0x30 << (local_20 & 0x1f));
    }
