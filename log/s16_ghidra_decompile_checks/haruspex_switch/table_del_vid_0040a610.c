...
void table_del_vid(undefined4 param_1,int param_2)
...
[32m[32m[32m  strncpy(acStack_14,(char *)(*(int *)(param_2 + 0xc) + 8),4);[0m[0m[0m
  ...
  if ((-1 < (int)uVar2) && ((int)uVar2 < 0x1000)) {
    local_18 = local_18 | uVar2 | 0x8000;
...
[32m      reg_read(0x80,&local_18);[0m
  ...
  puts("wrong fid range, should be within 0~4095");
  return;
}

[ASK_GPT] 96e18453325c8cf4
