...
[32m  iVar1 = -(sVar2 + 0x40 & 0xfffffff8);[0m
  ...
  (**(code **)(local_28 + -0x7ee4))(file,patt,mtd_num);
  ...
  if (iVar3 == 0) {
    if ((res._4_4_ < 1) && ((res._4_4_ != 0 || ((uint)res < 0x80000000)))) {
      *value = (uint)res;
      ...
      pcVar7 = *(code **)(local_28 + -0x7e90);
      uVar6 = **(undefined4 **)(local_28 + -0x7ee8);
      ...
      *(char **)((int)apcStack_30 + iVar1) = file;
      ...
      puVar4 = (undefined4 *)(**(code **)(local_28 + -0x7ef0))();
      *puVar4 = 0x16;
      iVar5 = -1;
    }
  }
