...
[32m  memset(mtd,0,0x100);[0m
  ...
  if (iVar1 == 0) {
    iVar1 = -1;
    puVar5 = (undefined4 *)(**(code **)(puVar8 + -0x7f78))();
    *puVar5 = 0x13;
  }
  else {
        ...
        if (-1 < (int)uVar3) {
          ...
          if ((((iVar2 == 0) &&
            ...
            *(uint *)&mtd->field_0xf8 = uVar6 & 0xfffffffe | uVar4;
            ...
            iVar1 = (**(code **)(puVar8 + -0x7f6c))(buf,"nand");
            if (iVar1 == 0) {
              mtd->type = 4;
              iVar1 = 1;
            }
            else {
              iVar1 = (**(code **)(puVar8 + -0x7f6c))(buf,"mlc-nand");
              if (iVar1 == 0) {
                mtd->type = 8;
                iVar1 = 1;
              }
              else {
                iVar1 = (**(code **)(puVar8 + -0x7f6c))(buf,&DAT_00406b4c);
                uVar3 = 3;
                if (iVar1 != 0) {
                  iVar1 = (**(code **)(puVar8 + -0x7f6c))(buf,&DAT_00406b50);
                  uVar3 = 2;
                  if (iVar1 != 0) {
                    iVar1 = (**(code **)(puVar8 + -0x7f6c))(buf,"absent");
                    uVar3 = 0;
                    if (iVar1 != 0) {
                      iVar1 = (**(code **)(puVar8 + -0x7f6c))(buf,"dataflash");
                      uVar3 = 6;
                      if (iVar1 != 0) {
                        iVar1 = (**(code **)(puVar8 + -0x7f6c))(buf,&DAT_00406b68);
                        uVar3 = 1;
                        if (iVar1 != 0) {
                          iVar1 = (**(code **)(puVar8 + -0x7f6c))(buf,&DAT_00406b6c);
