...
void FUN_004066b4(char **param_1,undefined4 param_2,undefined4 param_3,char *param_4,char *param_5)
...
[32m[32m[32m    __s = (char *)malloc(sVar1 + sVar2 + 0x144 + sVar3);[0m[0m[0m
    iVar4 = sprintf(__s,
...
[32m[32m                    ,*param_1,param_4,param_5,"></s:Body></s:Envelope>");[0m[0m
    FUN_00405000(param_1[8]);
    ILibParseUri(param_1[2],&local_4c,local_50,&local_48);
    sVar1 = strlen(local_48);
    sVar2 = strlen(local_4c);
    sVar3 = strlen(*param_1);
[32m[32m[32m    __s_00 = (char *)malloc(sVar1 + sVar2 + 0xac + sVar3);[0m[0m[0m
    local_30 = sprintf(__s_00,
                       "POST %s HTTP/1.0\r\nHost: %s:%d\r\nUser-Agent: POSIX, UPnP/1.0, Intel MicroStack/1.0.1423\r\nSOAPACTION: \"%s#%s\"\r\nContent-Type: text/xml\r\nContent-Length: %d\r\n\r\n"
[32m[32m                       ,local_48,local_4c,(uint)local_50[0],*param_1,"ConfigureConnection",iVar4);[0m[0m
    local_40 = 0;
    local_3c = 0;
    local_38 = 0;
    local_44._2_2_ = 0;
    ...
    *(undefined4 *)(__ptr + 8) = param_3;
    ILibAddRequest_DirectEx
              (*(undefined4 *)(*piVar5 + 0x2c),__s_00,local_30,__s,iVar4,&local_44,FUN_0040a6b4,
               param_1,__ptr);
    free(local_4c);
    __ptr = local_48;
  }
