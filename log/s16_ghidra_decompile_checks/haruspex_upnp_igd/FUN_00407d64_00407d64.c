...
void FUN_00407d64(char **param_1,undefined4 param_2,undefined4 param_3,char *param_4)
...
[32m[32m[32m    __s = (char *)malloc(sVar1 + sVar2 + 0x131);[0m[0m[0m
    iVar3 = sprintf(__s,
...
[32m[32m                       ,local_48,local_4c,(uint)local_50[0],*param_1,"SetConnectionType",iVar3);[0m[0m
    local_40 = 0;
    local_3c = 0;
    local_38 = 0;
    local_44._2_2_ = 0;
    ...
    *(undefined4 *)(__ptr + 8) = param_3;
    ILibAddRequest_DirectEx
              (*(undefined4 *)(*piVar5 + 0x2c),__s_00,local_30,__s,iVar3,&local_44,FUN_0040b524,
               param_1,__ptr);
    free(local_4c);
    __ptr = local_48;
  }
