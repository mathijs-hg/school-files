...
void FUN_00405f50(char **param_1,undefined4 param_2,undefined4 param_3,uint param_4)
...
[32m[32m[32m    __s = (char *)malloc(sVar1 + 0x14c);[0m[0m[0m
    iVar2 = sprintf(__s,
...
[32m[32m                       iVar2);[0m[0m
    ...
    *(undefined4 *)(__ptr + 8) = param_3;
    ILibAddRequest_DirectEx
              (*(undefined4 *)(*piVar5 + 0x2c),__s_00,local_30,__s,iVar2,&local_44,FUN_00409bbc,
               param_1,__ptr);
    free(local_4c);
    __ptr = local_48;
  }
