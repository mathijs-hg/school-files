...
void FUN_0040694c(char **param_1,undefined4 param_2,undefined4 param_3)
...
[32m[32m[32m    __s = (char *)malloc(sVar1 + 0x120);[0m[0m[0m
    iVar2 = sprintf(__s,
...
[32m[32m[32m    __s_00 = (char *)malloc(sVar1 + sVar3 + 0xb5 + sVar4);[0m[0m[0m
...
[32m[32m                       iVar2);[0m[0m
    ...
    *(undefined4 *)(__ptr + 8) = param_3;
    ILibAddRequest_DirectEx
              (*(undefined4 *)(*piVar5 + 0x2c),__s_00,local_30,__s,iVar2,&local_44,FUN_0040a7a0,
               param_1,__ptr);
    free(local_4c);
    __ptr = local_48;
  }
