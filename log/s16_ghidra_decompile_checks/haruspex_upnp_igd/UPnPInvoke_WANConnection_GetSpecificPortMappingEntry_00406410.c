...
void UPnPInvoke_WANConnection_GetSpecificPortMappingEntry
...
[32m[32m[32m    __s = (char *)malloc(local_30 + sVar1 + 0x180 + sVar2);[0m[0m[0m
    iVar3 = sprintf(__s,
...
[32m[32m[32m    __s_00 = (char *)malloc(sVar1 + sVar2 + 0xb4 + sVar4);[0m[0m[0m
...
[32m[32m[32m                       iVar3);[0m[0m[0m
    ...
    *(undefined4 *)(__ptr + 8) = param_3;
    ILibAddRequest_DirectEx
              (*(undefined4 *)(*piVar5 + 0x2c),__s_00,local_30,__s,iVar3,&local_44,FUN_0040a264,
               param_1,__ptr);
    free(local_4c);
    __ptr = local_48;
  }
