...
void FUN_00405848(char **param_1,undefined4 param_2,undefined4 param_3)
...
[32m[32m[32m    __s = (char *)malloc(sVar1 + 0xfe);[0m[0m[0m
    iVar2 = sprintf(__s,"%sGetUserName xmlns:u=\"%s\"></u:GetUserName%s",
...
[32m[32m[32m    __s_00 = (char *)malloc(sVar1 + sVar3 + 0xa4 + sVar4);[0m[0m[0m
    local_30 = sprintf(__s_00,
                       "POST %s HTTP/1.0\r\nHost: %s:%d\r\nUser-Agent: POSIX, UPnP/1.0, Intel MicroStack/1.0.1423\r\nSOAPACTION: \"%s#%s\"\r\nContent-Type: text/xml\r\nContent-Length: %d\r\n\r\n"
[32m[32m                       ,local_48,local_4c,(uint)local_50[0],*param_1,"GetUserName",iVar2);[0m[0m
    local_40 = 0;
    local_3c = 0;
    local_38 = 0;
    local_44._2_2_ = 0;
    ...
    *(undefined4 *)(__ptr + 8) = param_3;
    ILibAddRequest_DirectEx
              (*(undefined4 *)(*piVar5 + 0x2c),__s_00,local_30,__s,iVar2,&local_44,FUN_004094a0,
               param_1,__ptr);
    free(local_4c);
    __ptr = local_48;
  }
