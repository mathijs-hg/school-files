...
start()
{
	...
	/etc/init.d/https-0 start
	/etc/init.d/smtps-0 start
	/etc/init.d/smtps-snapshot-0 start
...
stop()
{
	...
	/etc/init.d/https-0 stop
	/etc/init.d/smtps-0 stop
	/etc/init.d/smtps-snapshot-0 stop
