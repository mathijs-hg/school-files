...
var LooginType=decodeBase64("<% getEventServerFTPInfo(LoginType); %>");
//for snapshot
...
var LooginType_snapshot=decodeBase64("<% getEventServerFTPSnapshotInfo(LoginType); %>");
var pwd_dirty=0;
...
function loadText()
{
	...
	setText(document.getElementById("sLoginType"), item_name[I_LOGIN_TYPE]);
	setText(document.getElementById("sLoginType_snapshot"), item_name[I_LOGIN_TYPE]);
	...
	for (var i = 0; i < document.getElementById("selectLoginType").length; i++)
	{
		document.getElementById("selectLoginType").options[i].text = option_content[O_LOGINT_TYPE_USERPWD + i];
	}
	for (var i = 0; i < document.getElementById("selectLoginType_snapshot").length; i++)
	{
		document.getElementById("selectLoginType_snapshot").options[i].text = option_content[O_LOGINT_TYPE_USERPWD + i];
	}
}
function setConfig()
{
	...
	document.getElementById("selectLoginType").value = LooginType;
	document.getElementById("selectLoginType_snapshot").value = LooginType_snapshot;
}
...
function save_setting()
{
	...
	params += "&LoginType=" + encodeURIComponent(document.getElementById("selectLoginType").value);	
	params += "&LoginType_S=" + encodeURIComponent(document.getElementById("selectLoginType_snapshot").value);
...
function resetDefaultConfig()
{
	...
	LooginType = document.getElementById("selectLoginType").value;
	LooginType_snapshot = document.getElementById("selectLoginType_snapshot").value;
	//setConfig();
	//resizePage();	
}
...
{
	if (document.getElementById("selectLoginType").value == "0")
	{
		document.getElementById("input_ftp_uid").disabled = false;
		document.getElementById("input_ftp_pwd").disabled = false;
	}
	else if (document.getElementById("selectLoginType").value == "1")
	{
		document.getElementById("input_ftp_uid").disabled = false;
		document.getElementById("input_ftp_pwd").disabled = true;
		document.getElementById("input_ftp_pwd").value = "";
		pwd_dirty=1;
	}
	else if (document.getElementById("selectLoginType").value == "2")
	{
		document.getElementById("input_ftp_uid").disabled = true;
		document.getElementById("input_ftp_pwd").disabled = true;
...
function onLoginTypeSnapshotChanged()
{
	if (document.getElementById("selectLoginType_snapshot").value == "0")
	{
		document.getElementById("input_ftp_uid_snapshot").disabled = false;
		document.getElementById("input_ftp_pwd_snapshot").disabled = false;
	}
	else if (document.getElementById("selectLoginType_snapshot").value == "1")
	{
		document.getElementById("input_ftp_uid_snapshot").disabled = false;
		document.getElementById("input_ftp_pwd_snapshot").disabled = true;
		document.getElementById("input_ftp_pwd_snapshot").value = "";
		pwd_dirty_snapshot=1;
	}
	else if (document.getElementById("selectLoginType_snapshot").value == "2")
	{
		document.getElementById("input_ftp_uid_snapshot").disabled = true;
		document.getElementById("input_ftp_pwd_snapshot").disabled = true;
		document.getElementById("input_ftp_uid_snapshot").value = "anonymous";
		document.getElementById("input_ftp_pwd_snapshot").value = "";
		pwd_dirty_snapshot=1;
	} 
}
    			  ...
    			  <td>
    				<div id="maincontent">
        				...
        				<table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">
        				  ...
        				  <TR>
          					<TD>&nbsp;<span id="sLoginType_snapshot">Login Type</span></TD>
          					<TD>
          					  <span>&nbsp;&nbsp;</span>
          					  <select id="selectLoginType_snapshot" onchange="onLoginTypeSnapshotChanged();">
          					    <option value="0" selected="selected">User Name and Password</option>
          					    <option value="1">User Name only</option>
        				  ...
        				  <TR>
          					...
          					<TD>
          					  <span>&nbsp;&nbsp;</span>
          					<INPUT type="password" size=36 maxlength=32 id="input_ftp_pwd_snapshot" name="input_ftp_pwd_snapshot" value="" onclick="this.value='';pwd_dirty_snapshot=1;" onchange="pwd_dirty_snapshot=1"></TD>
        				  </TR>
        				  <TR>
        				...
        				<table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">
        				  ...
        				  <TR>
          					<TD>&nbsp;<span id="sLoginType">Login Type</span></TD>
          					<TD>
          					  <span>&nbsp;&nbsp;</span>
          					  <select id="selectLoginType" onchange="onLoginTypeChanged();">
          					    <option value="0" selected="selected">User Name and Password</option>
          					    <option value="1">User Name only</option>
          					    <option value="2">Anonymous</option>
          					  </select>
        				  ...
        				  <TR>
          					...
          					<TD>
          					  <span>&nbsp;&nbsp;</span>
          					<INPUT type="password" size=36 maxlength=32 id="input_ftp_pwd" name="input_ftp_pwd" value="" onclick="this.value='';pwd_dirty=1;" onchange="pwd_dirty=1"></TD>
        				  </TR>
        				  <TR>
