        			  ...
        			  <h2><span id="sEmailTitle_snapshot">E-mail Account - Snapshot</span></h2>
        			    <table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">
        				  ...
        				  <TR>
          				    ...
          				    <TD>
          				      <span>&nbsp;</span>
          				      <INPUT type="password" size=36 maxlength=32 id="input_smtp_pwd_snapshot" name="input_smtp_pwd_snapshot" value="" onclick="this.value='';pwd_dirty_snapshot=1;" onchange="pwd_dirty_snapshot=1">
          				    </TD>
        				  </TR>
        				  <TR>
        			  ...
        			  <h2><span id="sEmailTitle">E-mail Account - Video Clip</span></h2>
        			    <table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">
        				  ...
        				  <TR>
          				    ...
          				    <TD>
          				      <span>&nbsp;</span>
          				      <INPUT type="password" size=36 maxlength=32 id="input_smtp_pwd" name="input_smtp_pwd" value="" onclick="this.value='';pwd_dirty=1" onchange="pwd_dirty=1">
          				    </TD>
        				  </TR>
        				  <TR>
