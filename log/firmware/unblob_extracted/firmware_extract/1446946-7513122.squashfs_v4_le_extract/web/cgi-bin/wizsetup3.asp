...
var DDNSPassword=decodeBase64("<% getSWDDNSInfo(PWD_FAKE); %>");
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575" style="display: none" onload="document.getElementById('if_data').src = 'wizard_data.asp?' + g_token">
  <table id="tb_top" class="header_container" border="0" cellpadding="5" cellspacing="0" width="838" align="center">
    <tr>
      <td width="100%"><span id="sProduct">Product</span>: <a href="http://www.dlink.com/" target="_blank" style="color:white;text-decoration:none"><span id="sProduct_value"></span></a></td>
                		  ...
                		  <TD>    
                		    <div id="div_ddns_setting">
                  			  <table id="id_box_DDNS" cellspacing=0 cellpadding=3 BORDER=0 class=maintext>
                    			  ...
                    			  <td><INPUT type="password" size=32 maxlength=32 id="input_ddns_pwd" name="input_ddns_pwd" value="" onclick="this.value='';pwd_dirty=1;" onchange="pwd_dirty=1"></td>
                  			    </tr>
                  			    <tr>
