...
document.write("<script language=\"JavaScript\" type=\"text/javascript\" src=\"lang/" + language + "/lang_factory_status.js\"></scr" + "ipt>");
</script>
<script type="text/javascript" language="Javascript">
var num=60;
function loadText()
{
	setText(document.getElementById("sTitle"), item_name[I_RESTORE_FACTORY_DEFAULT]);
	document.getElementById("sTitleInfo").innerHTML= des_item_name[D_FACTORY_INFO];
}
function resizePage()
{
	if (parent)
    			...
    			<tr>
    			  <td>
    				<div id="maincontent">
      				  <!-- === BEGIN MAINCONTENT === -->
      				  <div id="box_header"> 
      					<h1><span id="sTitle">Restore Factory Defaults</span></h1>
      					<span id="sTitleInfo">
      					  The camera has been reset to factory settings.<br><br>
