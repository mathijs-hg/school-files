...
var WepKey0=decodeBase64("<% getWirelessClientInfo(WEPKey0_FAKE); %>");
var WepKey1=decodeBase64("<% getWirelessClientInfo(WEPKey1_FAKE); %>");
var WepKey2=decodeBase64("<% getWirelessClientInfo(WEPKey2_FAKE); %>");
var WepKey3=decodeBase64("<% getWirelessClientInfo(WEPKey3_FAKE); %>");
var PreSharedKey=decodeBase64("<% getWirelessClientInfo(PreSharedKey_FAKE); %>");
var Channel_Sel = Channel;
var pwd_dirty_wep0=0;
var pwd_dirty_wep1=0;
var pwd_dirty_wep2=0;
var pwd_dirty_wep3=0;
var pwd_dirty_presharedkey=0;
function resizePage()
{
	if (parent)
	{
...
function save_setting()
{
	...
	if (document.getElementById("input_wifi_enable").checked)
	{
		...
		else if (document.getElementsByName("radio_security_mode")[1].checked)
		{
			...
			var isDirty = 0;
			if (iActiveKey == 0)
				isDirty = pwd_dirty_wep0;
			else if (iActiveKey == 1)
				isDirty = pwd_dirty_wep1;
			else if (iActiveKey == 2)
				isDirty = pwd_dirty_wep2;
			else if (iActiveKey == 3)
				isDirty = pwd_dirty_wep3;
				
			//check key is empty first
			if (document.getElementById(keyname).value == "" ||　document.getElementById(keyname).value.length == 0)
			{
		...
		else if (document.getElementsByName("radio_security_mode")[2].checked)
		{
			...
			//check key is empty first
			if (document.getElementById("input_preSharedKey").value == "" ||　document.getElementById("input_preSharedKey").value.length == 0)
			{
        			      ...
        			      <div id="id_wep">
        			        ...
        			        <table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">  
        				      ...
        				      <TR>
          				        ...
          				        <TD>&nbsp;<INPUT type="password" size=32 id="input_key0" name="input_key0" value="" maxlength="26" onclick="this.value='';pwd_dirty_wep0=1;" onchange="pwd_dirty_wep0=1"></TD>
        				      </TR>
        				      <TR>
          				        <TD style="width: 180"><span id="sKey2">Key2</span></TD>
          				        <TD>&nbsp;<INPUT type="password" size=32 id="input_key1" name="input_key1" value="" maxlength="26" onclick="this.value='';pwd_dirty_wep1=1;" onchange="pwd_dirty_wep1=1"></TD>
        				      </TR>
        				      <TR>
          				        <TD style="width: 180"><span id="sKey3">Key3</span></TD>
          				        <TD>&nbsp;<INPUT type="password" size=32 id="input_key2" name="input_key2" value="" maxlength="26" onclick="this.value='';pwd_dirty_wep2=1;" onchange="pwd_dirty_wep2=1"></TD>
        				      </TR>
        				      <TR>
          				        <TD style="width: 180"><span id="sKey4">Key4</span></TD>
          				        <TD>&nbsp;<INPUT type="password" size=32 id="input_key3" name="input_key3" value="" maxlength="26" onclick="this.value='';pwd_dirty_wep3=1;" onchange="pwd_dirty_wep3=1"></TD>
        				      </TR>
        			        </table>
      				      </div>
      				      <div id="id_wpa">
        			        ...
        			        <table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">
        				      <TR>
          				        ...
          				        <TD>
          				          &nbsp;<INPUT type="password" size=24 maxlength=64 id="input_preSharedKey" name="input_preSharedKey" value="" onclick="this.value='';pwd_dirty_presharedkey=1;" onchange="pwd_dirty_presharedkey=1"> 
						        </TD>
        				      </TR>
        				      <TR>
          				        <TD width="180"></TD>
