...
function resizePage()
{
	if (parent)
	{
		parent.resetIframeHeight(document.body.clientHeight+500);
	}
}
...
function onLevelChange()
{
	...
	$('#video')[0].setlimit(document.getElementById("selectLevel").value);
}
...
//flash player ===================================================================
      ...
      {   	
      	onLevelChange();
	$('#video')[0].video_play("http://" + location.host + "/cgi/audio/audio.cgi?type=PCM"); 
      }
