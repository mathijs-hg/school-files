...
{
	var language = (navigator.userLanguage || navigator.language || navigator.browserLanguage).toLowerCase();
...
function CheckBrower()
{
  ...
  {
     var ver=bv.indexOf("Chrome/",0);
     if (ver == -1)
     	return("Chrome");
     ver += 7;
     if (ver == bv.length)
     	return("Chrome");
     var space=bv.indexOf(" ",ver);
     if (space == -1)
	 	return("Chrome/" + bv.substring(ver,bv.length));
     space += 1;
     if (space == bv.length)
     	return("Chrome/" + bv.substring(ver,bv.length));
	 else
	 	return("Chrome/" + bv.substring(ver,space));
  }
...
function CheckSrvname(str)
{
    ...
    else
    {
       for (i=0;i<str.length;i++)
       {
           ...
           if ((j <= 33) || (j == 34) || (j == 35) || (j == 36) || (j == 37) || (j == 38) || (j == 39) || (j == 40) 
               || (j == 41) || (j == 42) || (j == 43) || (j == 44) || (j == 46) || (j == 47) || (j == 58) || (j == 59) || (j == 60) 
               || (j == 61) || (j == 62) || (j == 63) || (j == 64) || (j == 91) || (j == 92) || (j == 93) || (j == 94) || (j == 96) 
               || (j == 123)  || (j == 125) || (j >= 126))
              return 1;
       }
       return 0;
