...
function init(bReinit) 
{
	...
	if (!bReinit)
	{
		...
		{
			//document.getElementById("box_header2").style.display = "none";
			document.getElementById("table_cam_control").style.display = "none";
		}
		loadText();
	    	setConfig();
...
{
	setText(document.getElementById("sResolution"), res);
}
					  ...
					  <div class="box">
				        ...
				        <table id="table_cam_control" cellpadding="2" cellspacing="1" border="0" width="100%" bgcolor="white" bordercolor="#FFFFFF" style="vertical-align: middle;">
					      <tr>
					    	  ...
					    	  <span>&nbsp&nbsp&nbsp</span>
					    	  <span style="vertical-align:middle" id='zoom_box'><span id="sZooomInOut">Zoom in/out</span> :</span>
