...
function DoSumitAdmin()
{
	...
	var password = "";
	setText(document.getElementById("sWarningMessage"), "");
	for (var i = 1; i < account.length; i++)
	{
		password = password + account[i];
		if (i != (account.length - 1))
			password += ":"
	}

  	if ((document.getElementById("OldPassword").value == password) && (document.getElementById("NewPassword").value == document.getElementById("RetypePassword").value))
  	{
...
{	
	...
	else
	{
		...
		{
			if (document.getElementById("UserName").value == decodeBase64(usersList[i]))
			{
				userExist=1;
				break;
			}
		...
		if (userExist == 1)
		{
			setText(document.getElementById("sWarningMessage"), document.getElementById("UserName").value + " " + item_name[I_USER_ALREADY_EXIST]);
			return;
		}
		/*
		if (document.getElementById("UserName").value == "admin")
    			...
    			<tr>
    			  <td>
    				<div id="maincontent">
						...
						<br>
						<span id="sWarningMessage" style="color:red"></span>
      				  </div>
      				  <div class="box">
        				...
        				<table cellpadding="2" cellspacing="1" border="0" bgcolor="white" bordercolor="#FFFFFF">
        				  <TR>
          					...
          					<TD colspan=2>
          					  &nbsp;<INPUT type="text" size=30 maxlength=26 id="input_camera_name" name="input_camera_name" value="">
          					  &nbsp;<span style="color:red" id="sCameraNameLengthDes">26 characters maximum</span>
          					</TD>
        				  </TR>
        				  <TR>
        				...
        				<table cellpadding="2" cellspacing="1" border="0" bgcolor="white" bordercolor="#FFFFFF">  
        				  <TR>
            				  ...
            				  &nbsp;&nbsp;
            				  <INPUT id="btnCancel2" type="button" width="80" value="Cancel" onClick="setText(document.getElementById('sWarningMessage'), '');init(true);">
          					</TD>
        				  </TR>
        				</table>
      				  </div>
